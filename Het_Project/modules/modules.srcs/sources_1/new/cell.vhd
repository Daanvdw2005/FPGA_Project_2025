-- cell.vhd
-- Jouw perfecte cel met groot rood kruisje (sqBorder=30, crossThickness=22)
library IEEE;
...
entity cell is
    ...
    port (
        ...
        reset     : in  std_logic;
        sel       : in  std_logic;
        turn      : in  std_logic;      -- '0'=X, '1'=O (later gebruikt)
        ...
        state_out : out std_logic_vector(1 downto 0) := "00"  -- 00=leeg, 01=X, 10=O
    );
end cell;
...
architecture Behavioral of cell is
    ...
    -- border_sel functie - jouw mooie effect!
                   ...
                   y_rel < CELL_SIZE - sqBorder - border_sel(state /= EMPTY, plsBorder) then
                    ...
                    if abs(x_rel - y_rel) < crossThickness or
                       abs(x_rel + y_rel - (CELL_SIZE-1)) < crossThickness then
                        rgb_out <= "111100000000";  -- jouw mooie rode X
                    end if;
                end if;
            end if;
